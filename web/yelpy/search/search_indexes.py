...
from search.models import sportslistings
...
class SportsIndex(indexes.SearchIndex, indexes.Indexable):
    text = indexes.CharField(document=True, use_template=True)
    ...
    display_phone = indexes.CharField(model_attr='display_phone', null=True)
    deals = indexes.CharField(model_attr='deals', null=True)
    gift_certificates = indexes.CharField(model_attr='gift_certificates', null=True)

    def get_model(self):
        return sportslistings
